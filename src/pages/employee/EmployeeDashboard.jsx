...
const EmployeeDashboard = () => {
  ...
  return (
    <div className="employee-dashboard">
      <h1 className="text-2xl font-semibold mb-4 sm:mb-6">Employee Dashboard</h1>
        ...
        {isLoading ? (
          <>
            <div className="bg-white rounded-lg shadow p-3 sm:p-6">
              <Skeleton className="h-5 w-24 sm:w-32 mb-2 sm:mb-4" />
          ...
          <>
            <div className="bg-white rounded-lg shadow p-3 sm:p-6">
              ...
              <p className="mt-1 sm:mt-2 text-xl sm:text-3xl font-bold">{requestStatusCounts.total}</p>
            </div>
            <div className="bg-white rounded-lg shadow p-3 sm:p-6">
              <h2 className="text-yellow-500 text-xs sm:text-sm font-medium">Pending</h2>
              <p className="mt-1 sm:mt-2 text-xl sm:text-3xl font-bold">{requestStatusCounts.pending}</p>
            </div>
            <div className="bg-white rounded-lg shadow p-3 sm:p-6">
              <h2 className="text-green-500 text-xs sm:text-sm font-medium">Approved</h2>
              <p className="mt-1 sm:mt-2 text-xl sm:text-3xl font-bold">{requestStatusCounts.approved}</p>
            </div>
            <div className="bg-white rounded-lg shadow p-3 sm:p-6">
              <h2 className="text-red-500 text-xs sm:text-sm font-medium">Rejected</h2>
              <p className="mt-1 sm:mt-2 text-xl sm:text-3xl font-bold">{requestStatusCounts.rejected}</p>
            </div>
          </>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="flex justify-between items-center p-4 sm:p-6 border-b">
          ...
          <Link to="/employee/requests" className="text-blue-500 hover:text-blue-700 text-sm sm:text-base">
            View All
          </Link>
        </div>
              ...
              {isLoading ? (
                Array(5).fill(0).map((_, index) => (
                  <tr key={`skeleton-${index}`}>
                    ...
                    <td className="px-3 sm:px-6 py-2 sm:py-4 whitespace-nowrap">
                      <Skeleton className="h-5 w-16 sm:w-28" />
                    </td>
                    <td className="px-3 sm:px-6 py-2 sm:py-4 whitespace-nowrap">
      ...
      <div className="mt-6 sm:mt-8 text-center">
        <Link
          ...
          className="inline-flex items-center px-3 sm:px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm sm:text-base font-medium rounded-md transition-colors"
        >
